...
$ApiUrls = @(
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=45905639",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=04014252",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=26184291",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=03494540",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=39300801",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=39301117",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=37240220",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=40618131",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=45159978",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=38536252",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=44110123",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=43470010",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=39302152",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=39301337",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=38345436",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=41601843",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=02317304",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=00022680",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=45048943",
    "http://api.spending.gov.ua/api/v2/disposers/addendums?disposerId=45776308"
)

# Шляхи до вихідних файлів
$JsonOutputFile = "CombinedApiDataAddendums.json"
$JsOutputFile = "CombinedApiDataAddendums.js"
...
foreach ($Url in $ApiUrls) {
    ...
    Write-Progress -Activity "Збір даних (Додаткові угоди) з API" -Status "Обробка посилання $Counter з $TotalUrls..." -PercentComplete (($Counter / $TotalUrls) * 100) -CurrentOperation $Url
    ...
    try {
        ...
        # Логіка залишилася коректною завдяки структурі відповіді API
...
Write-Progress -Activity "Збір даних (Додаткові угоди) з API" -Status "Завершено." -Completed

Write-Host "----------------------------------------------------------------------"
Write-Host "📊 Звіт про обробку:" -ForegroundColor Cyan
Write-Host "  ✅ Успішно зібрано: $($AllContent.Count) записів (Додаткові угоди)." -ForegroundColor Green
...
# Змінено назву змінної JS для відображення "Додаткові угоди"
$JsVariable = "const combinedApiDataAddendums = "
